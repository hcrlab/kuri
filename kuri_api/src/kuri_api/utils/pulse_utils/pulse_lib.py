...
pa_source_flags = c_int
pa_source_flags_t = pa_source_flags
pa_source_state = c_int
...
PA_NSEC_PER_SEC = 1000000000L
PA_PROP_WINDOW_ICON = 'window.icon'
PA_NSEC_PER_MSEC = 1000000L
PA_USEC_PER_MSEC = 1000L
...
PA_USEC_INVALID = 18446744073709551615L
...
PA_DECIBEL_MININFTY = -200.0
PA_PROP_WINDOW_NAME = 'window.name'
PA_NSEC_PER_USEC = 1000L
PA_API_VERSION = 12
PA_PROP_WINDOW_X11_XID = 'window.x11.xid'
PA_VOLUME_NORM = 65536L
...
PA_USEC_MAX = 18446744073709551614L
